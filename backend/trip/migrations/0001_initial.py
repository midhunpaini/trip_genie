# Generated by Django 4.2 on 2023-05-12 06:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.URLField(blank=True, max_length=2000, null=True)),
                ('booking_url', models.URLField(blank=True, max_length=2000, null=True)),
                ('hotel_url', models.URLField(blank=True, max_length=2000, null=True)),
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trip.trip')),
            ],
        ),
    ]
